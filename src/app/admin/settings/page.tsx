...
import { PageHeading, SectionCard } from "@/features/dashboard/ui";
import { DEFAULT_COMMISSION_PCT } from "@/mocks/dashboard";

const SAMPLE = 210000; // R2,100 sample sale

export default function AdminSettingsPage() {
  const [pct, setPct] = useState(DEFAULT_COMMISSION_PCT);
        ...
        <SectionCard title="Commission rate">
          <div className="p-5">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                {saved ? <Check className="size-4" /> : null} {saved ? "Saved" : "Save"}
              </button>
            </div>
